...
public final class GoogleCredentialsBuilder {
   ...
   *
   * <p>{@code credentialsPath} and {@code credentialsJson} are mutually exclusive. So if both are
   * provided (are non-{@code null}), this is an error.
   *
   ...
   * @throws IllegalArgumentException if both {@code credentialsPath} and {@code credentialsJson}
   *     are non-{@code null}.
   */
  ...
  private static GoogleCredentials getCredentialsFromPath(final String credentialsPath)
      throws IOException {
  ...
  private static GoogleCredentials getCredentialsFromJson(final String credentialsJson)
      throws IOException {
